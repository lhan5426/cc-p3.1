...
q1() {
  ...
  #awk 'BEGIN {FS='\t'; IGNORECASE=1; print $0} $8 == "las vegas"' /home/clouduser/yelp_academic_dataset_business.tsv | wc -l
  #
  # * pandas:
...
./runner.sh -t flat-files/mysql/redis/hbase"
